...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div class="modal fade" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
     <a href="./index.php">   <button type="button" class="ppp btn btn-primary" id='submit' onclick="$('#uni_modal form').submit()">Save</button></a>
  ...
  <div id="preloader"></div>
    ...
    <script type="text/javascript">
      ...
      $('#report_crime').click(function(){
        ...
        //  uni_modal("Login",'login.php');
        uni_modal("Report",'chatbot/');

        uni_modal("Login",'login.php');
          return false;
        }
         // uni_modal("Report",'manage_report.php');
         uni_modal("Report",'chatbot/index.php');
